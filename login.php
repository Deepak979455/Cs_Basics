    ...
    <style>
        ...
        *:after {
        ...
        body {
            ...
            /*background-image: url('daniel-korpai-pKRNxEguRgM-unsplash.jpg');
...
<body>
    ...
    <br>
    <div class="cont">
        <form method="post" action="logic/login_handler.php">
        ...
        <div class="sub-cont">
            ...
            <form action="logic/sign_up_handler.php" method="post">
